...
add(P("São quarenta e cinco tabelas, somando dezesseis milhões seiscentas e sessenta e nove mil duzentas e vinte e oito linhas em setenta e três vírgula três megabytes de formato colunar. Elas se organizam em quatro famílias."));
...
add(P([{ t: "A evolução dessa medida ao longo do trabalho descrito neste documento: de doze tabelas com procedência de pipeline para " },
       { t: "quarenta e quatro de quarenta e cinco", forte: true },
