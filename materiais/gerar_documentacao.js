...
add(P("São trinta e nove tabelas, somando cinco milhões trezentas e vinte e sete mil novecentas e sessenta e quatro linhas em quarenta e oito vírgula um megabytes de formato colunar. Elas se organizam em quatro famílias."));
...
add(P([{ t: "A evolução dessa medida ao longo do trabalho descrito neste documento: de doze tabelas com procedência de pipeline para " },
       { t: "trinta e oito de trinta e nove", forte: true },
