    ...
    secoes: [
      ...
      },
      {
        ...
        tabela: {
          ...
          nota: "Fonte: SIM/DataSUS, 2024 consolidado (arquivos .dbc do FTP, recoletados em setembro de 2026). Elaboração: Saúde em Dado.",
        },
      },
      {
        ...
        tabela: {
          ...
          nota: "Fonte: SIM/DataSUS, 2024 consolidado. R99 não é doença: é ausência de diagnóstico. Elaboração: Saúde em Dado.",
        },
      },
      {
    ...
    secoes: [
      ...
      },
      {
        ...
        paragrafos: [
          ...
          "Testamos a objeção óbvia: e se a comparação só fizer sentido dentro do mesmo porte? Refizemos a análise da forma mais rigorosa possível — densidade real de equipes (ESF por 10 mil habitantes, sem o teto artificial de capacidade) em vez do percentual saturado, cada município comparado apenas aos pares do próprio quartil de população, e %ICSAP em vez de ICSAP por 100 mil habitantes (que cai em municípios vulneráveis só porque o acesso hospitalar geral é menor lá, não porque a atenção primária seja melhor — outro confundidor, que só apareceu ao testar). O resultado não mudou: a correlação entre densidade de equipes e %ICSAP dentro do mesmo porte fica entre ρ = −0,02 e +0,18 conforme o quartil — sem relação prática. A co-ocorrência de baixa densidade de equipe com alto %ICSAP é 0,94 vezes o que a pura coincidência estatística preveria. O achado nulo sobrevive ao teste mais rigoroso que conseguimos desenhar.",
        ],
        tabela: {
