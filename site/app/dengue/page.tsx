...
export const metadata: Metadata = {
  ...
  description:
    "Casos prováveis, gravidade, óbitos e incidência de dengue (SINAN/DataSUS, 2015–2025) por município e semana epidemiológica, com canal endêmico e a epidemia recorde de 2024.",
  alternates: { canonical: "/dengue/" },
  openGraph: {
    title: "Dengue no Brasil por município e semana — Saúde em Dado",
    description: "Casos prováveis, gravidade, óbitos e incidência de dengue (SINAN/DataSUS, 2015–2025) por município e semana epidemiológica, com canal endêmico e a epidemia recorde de 2024.",
