    ...
    <div className="prose-doc mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-4">
        {[
          ...
          ["12 fontes", "SIM · SIH · SINAN · SINASC · PNI · CNES · SIOPS · e-Gestor AB · ANS · Painel Oncologia · SISAGUA · IBGE"],
      ...
      <ul>
        ...
        <li>
          ...
          (ρ = +0,002; +0,018 controlando porte e vulnerabilidade). Publicamos o dado com a
